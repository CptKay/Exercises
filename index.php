            ...
            <figure>
              ...
              <figcaption class="figure-caption text-center">
                <div class="col-md-12 text-center">
                  <button type="button" value="Start" class="btn btn-primary btn-lg mb-5 py-0" onClick="fortuneTeller();"> Future</button>
                  <button type="button" value="Hallo" class="btn btn-primary btn-lg mb-5 py-0" id="greeting-button" onClick="alert('Hallo');"> hallo</button>
                <script>
